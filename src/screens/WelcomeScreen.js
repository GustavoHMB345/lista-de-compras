  ...
  return (
    <LinearGradient colors={["#3B82F6", "#8B5CF6"]} style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>Organize suas compras, compartilhe com a família e controle seus gastos.</Text>
        <Image source={require('../../assets/images/react-logo.png')} style={styles.image} resizeMode="contain" />
        <TouchableOpacity style={[styles.button, { backgroundColor: '#3B82F6' }]} onPress={() => router.push('/sign-in')}>
          <Text style={styles.buttonText}>Entrar</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.button, { backgroundColor: '#10B981' }]} onPress={() => router.push('/sign-up')}>
